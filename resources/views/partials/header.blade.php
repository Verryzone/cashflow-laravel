    ...
    <div class="flex items-center gap-3 2xsm:gap-7">
      <ul class="flex items-center gap-2 2xsm:gap-4">
        ...
        <li
          ...
          onclick="show_absolute('notifmenu')"
        >
          <a
          ...
          <!-- Dropdown Start -->
          <div
            class="notifmenu-menu absolute -right-27 mt-2.5 flex h-90 w-75 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark sm:right-0 sm:w-80 hidden"
          >
        ...
        <li
          class="relative hover:cursor-pointer"
          onclick="show_absolute('messagesmenu')"
        >
          <a
            class="relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] border-stroke bg-gray hover:text-primary dark:border-strokedark dark:bg-meta-4 dark:text-white"
          >
          ...
          <!-- Dropdown Start -->
          <div
            class="messagesmenu-menu dropdown-chat absolute -right-16 mt-2.5 flex h-90 w-75 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark sm:right-0 sm:w-80 hidden"
          >
            <div class="px-4.5 py-3">
      ...
      >
        <a
          ...
          onclick="show_absolute('profilemenu')"
        >
          ...
          <div class="profilemenu-icon -rotate-90">
            <svg
        ...
        <!-- Dropdown Start -->
        <div
          class="profilemenu-menu absolute right-0 mt-4 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark hidden"
        >
          <ul
